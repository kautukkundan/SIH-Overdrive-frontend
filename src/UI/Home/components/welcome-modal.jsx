  ...
  <Modal defaultOpen closeIcon>
    ...
    <Modal.Content image>
      ...
      <Modal.Description>
        ...
        <p>
          1. You will find all the problem statements from the official website
          in 1 place
          <br />
          <br />
          2. You can mark progress with each problem statement. You can comment
          and discuss the problems with your team
          <br />
          <br />
          3. You can attach links to your proposal doc and ppt from the problem
          statements page.
          <br />
          <br />
        ...
        <p>
          ...
          <br />
          <br />
          So we thought of making a complete solution where we can view, analyze
          and discuss each problem statement with comfort.
          <br />
          <br />
